...
mod pong_tests {
    ...
    impl PongHarness {
        ...
        fn send_ping(&mut self, n: u32) {
            self.machine
                .dispatch(Envelope(0, PingPongMsg::Ping(Ping { round: n })).into());
        }
        ...
        fn current_state(&self) -> Option<PongState> {
    ...
    fn start_enters_ready() {
        ...
        assert_eq!(h.current_state(), Some(PongState::Ready));
    }
