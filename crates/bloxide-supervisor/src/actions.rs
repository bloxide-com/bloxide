...
//!
//! These take the concrete event type `&SupervisorEvent<R>` directly — no
//! `SupervisorEventLike` trait abstraction. The `SupervisorEvent` enum is
//! generated by the codegen from the `[event]` section in `blox.toml`.
