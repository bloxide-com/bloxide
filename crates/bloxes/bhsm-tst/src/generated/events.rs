...
#[derive(Debug)]
pub enum BhsmTstEvent {
    /// Lifecycle command (Start/Reset/Stop/Ping).
    Lifecycle(::bloxide_core::lifecycle::LifecycleCommand),
    Msg(Envelope<bhsm_tst_messages::BhsmTstMsg>),
}
impl ::core::convert::From<Envelope<bhsm_tst_messages::BhsmTstMsg>> for BhsmTstEvent {
    fn from(envelope: Envelope<bhsm_tst_messages::BhsmTstMsg>) -> Self {
...
impl ::bloxide_core::event_tag::EventTag for BhsmTstEvent {
    #[inline]
...
impl ::bloxide_core::event_tag::LifecycleEvent for BhsmTstEvent {
...
impl BhsmTstEvent {
    ...
    pub fn msg_payload(&self) -> ::core::option::Option<&bhsm_tst_messages::BhsmTstMsg> {
        match self {
            BhsmTstEvent::Msg(ref e) => ::core::option::Option::Some(&e.1),
            _ => ::core::option::Option::None,
        }
    }
