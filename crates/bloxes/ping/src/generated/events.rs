...
impl ::core::convert::From<Envelope<ping_pong_messages::PingPongMsg>> for PingEvent {
    fn from(envelope: Envelope<ping_pong_messages::PingPongMsg>) -> Self {
        PingEvent::Msg(envelope)
    }
}
impl ::core::convert::From<::bloxide_core::lifecycle::LifecycleCommand> for PingEvent {
    fn from(cmd: ::bloxide_core::lifecycle::LifecycleCommand) -> Self {
        PingEvent::Lifecycle(cmd)
    }
}
impl ::bloxide_core::event_tag::EventTag for PingEvent {
    #[inline]
...
impl ::bloxide_core::event_tag::LifecycleEvent for PingEvent {
...
impl PingEvent {
    ...
    pub fn msg_envelope(
        ...
        match self {
            PingEvent::Msg(ref e) => ::core::option::Option::Some(e),
            _ => ::core::option::Option::None,
        }
    }
    ...
    pub fn msg_payload(&self) -> ::core::option::Option<&ping_pong_messages::PingPongMsg> {
        match self {
            PingEvent::Msg(ref e) => ::core::option::Option::Some(&e.1),
            _ => ::core::option::Option::None,
        }
    }
