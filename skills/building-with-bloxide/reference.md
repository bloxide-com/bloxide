...
Run `cargo blox generate` to produce `src/generated/events.rs`; the crate root re-exports the event type via `pub use generated::{PingCtx, PingEvent, PingSpec, PingState};` in `src/lib.rs`.
