...
async fn main() {
    ...
    let (spawn_ref, spawn_rx) = <TokioRuntime as ::bloxide_core::capability::DynamicChannelCap>::channel::<
    ...
    ::bloxide_tokio::spawn_child!(
        group, pool_task(pool_machine, pool_mbox, pool_id), ChildPolicy::Stop
    );
