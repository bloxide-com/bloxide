...
::bloxide_tokio::root_task!(
    supervisor_task, ::bloxide_supervisor::SupervisorSpec < TokioRuntime >
);
#[tokio::main]
async fn main() {
    ...
    let ((counter_ref,), counter_mbox) = ::bloxide_tokio::channels! {
        counter_messages::CounterMsg(16),
    };
    ...
    let sup_ctx = ::bloxide_supervisor::SupervisorCtx::new(
        sup_id,
        children,
        sup_notify_ref_0,
    );
    ...
    sup_machine
        .dispatch(
            ::bloxide_supervisor::SupervisorEvent::<
                TokioRuntime,
