...
Blanket implementations are generated by `bloxide-codegen` into `src/generated/mailboxes_impls.rs`
for 1- through 16-element tuples where each element `Si` implements `Stream<Item = Ti>`
and `E: From<Ti>`.
